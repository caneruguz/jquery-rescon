...
(function($) {
    $.fn.rescon = function(options) {
        ...
        this.runRescon = function (index, element){
            ...
            $(element).find('div[class^="col-"]').each(function(i, e){
               ...
               var currentSize = self.sizes.indexOf(self.currentMode); 
                ...
                if(newCols == ""){
                    var next = self.recurseUp(currentSize+1, dataString); 
                    for(var i = 0; i < dataList.length; i++) {
                        var o = dataList[i];
                        if(o.indexOf(self.sizes[next])  !== -1 ){
                            newCols += " "+o;
                        }
                    }
                }
                var begin = ""; 
                if(newclass.length > 0){ var begin = newclass+" "}
        ...
        this.recurseDown = function (index, dataString){
        ...
        this.recurseUp = function (index, dataString){
